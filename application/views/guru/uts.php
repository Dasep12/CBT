              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    <!-- Post -->
                    <div class="post">
                      <a href="<?= base_url('guru/Upload_soal') ?>" class="btn btn-danger btn-sm"><i class="fa fa-upload"></i> Upload Soal UTS</a>
                      <table class="table" id="uts">
                        ...
                        <tbody>
                          <?php $no = 0 ; foreach($list_uts as $soal) : ?>
                            <tr>
                              <td><?= ++$no ; ?></td>
...
function del(kode){
    ...
    .then((willDelete) => {
      if (willDelete) {
          $.ajax({
            url : "<?= base_url('guru/Soal_uts/delete') ?>",
            method : "GET",
            data : "kode="+kode ,

...
<body onload="waktu()" class="hold-transition layout-top-nav">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        <!-- Left navbar links -->
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="<?= base_url("guru/Settings") ?>" class="nav-link">Setting</a>
            </li>
          </ul>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ">        
        <li class="nav-item">
          ...
          <button class="btn btn-default btn-sm"><i class="fa fa-th"></i> <span id="detik"></span> <span id="output"></span></button>   
          </a>
        </li>
      </ul>
      <!-- Right navbar logout -->
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Sistem Informasi DWIPA</h1>
          </div>
          <div class="col-sm-6">

...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Lengkapi Data Untuk Ganti Password</p>
      <form onsubmit="return validasi()" id="login" action="<?= base_url('Forgetpass/ceknisn') ?>" method="post">
        ...
        <div class="input-group">
          <div class="input-group date" id="reservationdate" data-target-input="nearest">
                <input type="text" name="tgl_lahir" placeholder="Masukan Tanggal Lahir" id="tanggal" class="form-control datetimepicker-input" data-target="#tanggal"/>
                <div class="input-group-append" data-target="#tanggal" data-toggle="datetimepicker">
                    <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                </div>
            </div>
          </div>
          <a class="small mb-2" href="<?= base_url() ?>">Sudah Punya Akun ?</a>
        <div class="row">
          <!-- <div class="col-8">
...
<script type="text/javascript">
 ...
 function validasi(){
    if(document.getElementById('nisn').value == ""){
      toastr.info("Masukan NISN");
      return false ;
    }else if(document.getElementById("tanggal").value == ""){
      toastr.info("Masukan Tanggal Lahir");
      return false ;
    }

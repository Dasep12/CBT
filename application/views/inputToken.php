...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Input Token</p>
      <form onsubmit="return validasi()" id="login" action="<?= base_url('Forgetpass/cekToken') ?>" method="post">
        <div class="input-group mb-3">
          <input type="text" name="token" class="form-control" id="token" placeholder="Masukan Token Aktivasi ">
          ...
          <div class="col-12">
            ...
            <?php  if($this->session->flashdata("send")) {  ?>
              <div class="alert alert-info mt-3">
                <?= $this->session->flashdata("send") ?>
              </div>
            <?php  }elseif($this->session->flashdata("errtoken")) { ?>
              <div class="alert alert-info mt-3">
                <?= $this->session->flashdata("errtoken") ?>
              </div>
            <?php } ?>
          </div>
        </div>
...
<script type="text/javascript">
 ...
 function validasi(){
    if(document.getElementById('token').value == ""){
      toastr.info("Masukan Token Aktivasi");
      return false ;
    }

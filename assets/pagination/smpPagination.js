                ...
                for (var i = perPage; i < $blocks.length; i++) {
                    ...
                    if(i === $blocks.length-1) {
                        ...
                        $('.smpPagination--pagination-nav')
                            .append($('<button type="button">').text('Previous').addClass('smpPagination--pagination prev'))
                            .append($('<span>').text('1 - ' + perPage + ' / ' + $blocks.length).addClass('smpPagination--pagination-counter'))
                            .append($('<button type="button">').text('Next').addClass('smpPagination--pagination next')) ;
                    }
                }
